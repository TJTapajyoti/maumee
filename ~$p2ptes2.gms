...
EQB(TM) Refinery equipment scale /512*600/;
...
transport1(m,VCF,VCS).. transportation1(m,VCF,VCS) =E= farm_storage_X(m,VCF,VCS)*trans_cost2(VCF,VCS)*(1-z_trans1(m,VCF,VCS));


transport2(m,VCS,EQB).. transportation2(m,VCS,EQB) =E= z_trans2(m,VCS,EQB)*storage_refinery_X(m,VCS,EQB)*eq_trans_cost1(VCS,EQB) + storage_refinery_X(m,VCS,EQB)*eq_trans_cost2(VCS,EQB)*(1-z_trans2(m,VCS,EQB));
